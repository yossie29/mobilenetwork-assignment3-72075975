...
simcir.registerDevice('OHalfAdder',
{
  "width":550,
  "height":300,
  "showToolbox":false,
  ...
  "devices":[
    {"type":"In","id":"dev0","x":176,"y":144,"label":"X"},
    {"type":"DC","id":"dev1","x":32,"y":184,"label":"DC"},
    {"type":"Toggle","id":"dev2","x":96,"y":216,"label":"Toggle"},
    {"type":"Toggle","id":"dev3","x":96,"y":144,"label":"Toggle"},
    {"type":"In","id":"dev4","x":176,"y":216,"label":"Y"},
    {"type":"OR","id":"dev5","x":424,"y":120,"label":"OR"},
    {"type":"NOT","id":"dev6","x":264,"y":192,"label":"NOT"},
    {"type":"Out","id":"dev7","x":424,"y":216,"label":"C"},
    {"type":"Out","id":"dev8","x":496,"y":120,"label":"S"},
    {"type":"AND","id":"dev9","x":344,"y":208,"label":"AND"},
    {"type":"AND","id":"dev10","x":344,"y":152,"label":"AND"},
    {"type":"NOT","id":"dev11","x":264,"y":80,"label":"NOT"},
    {"type":"AND","id":"dev12","x":352,"y":88,"label":"AND"}
  ],
  "connectors":[
...
simcir.registerDevice('OFullAdder',
{
  "width":600,
  "height":300,
  "showToolbox":false,
  ...
  "devices":[
    {"type":"DC","id":"dev0","x":48,"y":104,"label":"DC"},
    {"type":"Toggle","id":"dev1","x":120,"y":48,"label":"Toggle","state":{"on":false}},
    {"type":"Toggle","id":"dev2","x":120,"y":104,"label":"Toggle","state":{"on":false}},
    {"type":"Toggle","id":"dev3","x":120,"y":160,"label":"Toggle","state":{"on":false}},
    {"type":"OR","id":"dev4","x":456,"y":128,"label":"OR"},
    {"type":"Out","id":"dev5","x":496,"y":48,"label":"S"},
    {"type":"Out","id":"dev6","x":528,"y":128,"label":"Cout"},
    {"type":"In","id":"dev7","x":192,"y":48,"label":"Cin"},
    {"type":"In","id":"dev8","x":192,"y":104,"label":"X"},
    {"type":"In","id":"dev9","x":192,"y":160,"label":"Y"},
    {"type":"OHalfAdder","id":"dev10","x":248,"y":128,"label":"OHalfAdder"},
    {"type":"OHalfAdder","id":"dev11","x":344,"y":72,"label":"OHalfAdder"}
  ],
  "connectors":[
    {"from":"dev1.in0","to":"dev0.out0"},
    {"from":"dev2.in0","to":"dev0.out0"},
